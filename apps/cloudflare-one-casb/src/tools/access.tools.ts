import type { PolicyTestCreateParams } from 'cloudflare/resources/zero-trust/access/applications.mjs'
import { z } from 'zod'
...
const toolDefinitions: Array<ToolDefinition<any>> = [
	...
	{
		name: 'zero_trust_access_user_active_sessions_list',
 ...
 */
export function registerZeroTrustAccessTools(agent: CASBMCP) {
